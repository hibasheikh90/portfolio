      ...
      <div className="max-w-5xl w-full grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col justify-center text-center md:text-left space-y-6">
          ...
          <div className="flex space-x-5 justify-center md:justify-start text-xl text-gray-400">
            <a href="https://github.com/hibasheikh90" className="hover:text-cyan-400 transition">
              <FaGithub />
            </a>
            <a href="https://www.linkedin.com/in/hiba-sheikh-a437472b4/" className="hover:text-cyan-400 transition">
              <FaLinkedin />
            </a>
            <a href="https://x.com/HibaSheikh90" className="hover:text-cyan-400 transition">
              <FaTwitter />
            </a>
          </div>
        </div>
